...
# ==========================================
    ...
    with col_main:
        ...
        if cards:
            ...
            # ✨ 終極黑魔法：利用單雙數改變外層標籤，並注入 3D 翻轉進場動畫！
            wrapper_tag = "div" if idx % 2 == 0 else "section"
            
            st.markdown(f"""
                <{wrapper_tag} style="animation: flipPage 0.5s cubic-bezier(0.25, 0.8, 0.25, 1) forwards;">
        ...
        # 🌟 注入換題動畫 CSS (精準指定 Streamlit 的表單元件)
        st.markdown("""
            <style>
